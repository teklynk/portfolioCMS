...
$sqlAbout = mysqli_query($db_conn, "SELECT heading, content FROM aboutus LIMIT 1;");
    ...
    <div class="col-lg-8">
        ...
        <form id="aboutForm" method="post" action="">
            ...
            <div class="form-group">
                <label>Heading</label>
                <input type="text" class="form-control" name="about_heading" value="<?php echo $row['heading']; ?>"
                       placeholder="About Me">
            </div>

            <div class="form-group">
                <label>HTML / Text</label>
                <textarea class="form-control tinymce" name="about_content"
