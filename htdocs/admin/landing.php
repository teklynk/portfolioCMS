...
$sqlLanding = mysqli_query($db_conn, "SELECT heading, introtext, skills, image FROM landing LIMIT 1");
    ...
    <div class="col-lg-8">
        ...
        <form role="landingForm" method="post" action="" enctype="multipart/form-data">
            <div class="form-group">
                <label>Heading</label>
                <input type="text" class="form-control" name="landing_heading" value="<?php echo $row['heading']; ?>"
                       placeholder="Welcome">
            </div>
            <div class="form-group">
                <label>Intro</label>
                <input type="text" class="form-control" name="landing_introtext"
                       value="<?php echo $row['introtext']; ?>" placeholder="John Doe">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Skills</label>
                <textarea class="form-control tinymce" name="landing_skills"
                          rows="20"><?php echo $row['skills']; ?></textarea>
            </div>
