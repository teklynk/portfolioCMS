    ...
    <div class="col-lg-8">
        ...
        <form role="socialmediaForm" method="post" action="">
            <div class="form-group">
                <label>Heading</label>
                <input type="text" class="form-control" name="social_heading" value="<?php echo $row['heading']; ?>"
                       placeholder="Follow Me">
            </div>
            <div class="form-group">
                <label>Facebook</label>
                <input type="url" class="form-control" name="social_facebook" value="<?php echo $row['facebook']; ?>"
                       placeholder="https://www.facebook.com/username">
            </div>
            <div class="form-group">
                <label>Twitter</label>
                <input type="url" class="form-control" name="social_twitter" value="<?php echo $row['twitter']; ?>"
                       placeholder="https://www.twitter.com/username">
            </div>
            <div class="form-group">
                <label>Google+</label>
                <input type="url" class="form-control" name="social_google" value="<?php echo $row['google']; ?>"
                       placeholder="https://plus.google.com/8675309/posts">
            </div>
            <div class="form-group">
                <label>GitHub</label>
                <input type="url" class="form-control" name="social_github" value="<?php echo $row['github']; ?>"
                       placeholder="https://www.github.com/username/">
            </div>
            <div class="form-group">
                <label>LinkedIn</label>
                <input type="url" class="form-control" name="social_linkedin" value="<?php echo $row['linkedin']; ?>"
