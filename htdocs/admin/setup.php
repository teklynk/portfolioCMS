...
$sqlSetup = mysqli_query($db_conn, "SELECT title, author, description, keywords, headercode, googleanalytics, tinymce FROM setup LIMIT 1");
    ...
    <div class="col-lg-8">
        ...
        <form role="setupForm" method="post" action="setup.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="site_title" value="<?php echo $row['title']; ?>"
                       placeholder="My Portfolio Site">
            </div>
            <div class="form-group">
                <label>Author</label>
                <input type="text" class="form-control" name="site_author" value="<?php echo $row['author']; ?>"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="site_google"
                       value="<?php echo $row['googleanalytics']; ?>" placeholder="UA-XXXX-Y">
            </div>
            <?php
            if ($row['tinymce'] == 1) {
                $selEditor1 = "SELECTED";
