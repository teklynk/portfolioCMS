...
$sqlFooter = mysqli_query($db_conn, "SELECT heading, content FROM footer LIMIT 1");
    ...
    <div class="col-lg-8">
        ...
        <form id="footerForm" method="post" action="">
            ...
            <div class="form-group">
                <label>Heading</label>
                <input type="text" class="form-control" name="footer_heading" value="<?php echo $row['heading']; ?>"
                       placeholder="About Me">
            </div>

            <div class="form-group">
                <label>HTML / Text</label>
                <textarea class="form-control tinymce" name="footer_content"
